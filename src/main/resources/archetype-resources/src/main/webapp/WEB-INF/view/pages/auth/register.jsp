		...
		<div class="register-box">
			...
			<div class="register-box-body">
				...
				<form name="registerForm" class="c-auth-form" action="register" method="post">
					...
					<div class="form-group has-feedback" ng-class="{'has-error':registerForm.password2.${symbol_dollar}error.passwordMatch}">
					...
					<button ng-disabled="registerForm.password2.${symbol_dollar}error.passwordMatch"
