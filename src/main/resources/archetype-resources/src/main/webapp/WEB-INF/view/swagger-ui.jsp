...
<head>
  ...
  <script src='res/vendor/springfox/springfox.js' type='text/javascript'></script>
</head>
...
<div id='header'>
  <div class="swagger-ui-wrap">
    ...
    <form id='api_selector'>
      ...
      <div class='input'><a id="explore" href="${symbol_pound}" data-sw-translate>Explore</a></div>
    </form>
  </div>
</div>
