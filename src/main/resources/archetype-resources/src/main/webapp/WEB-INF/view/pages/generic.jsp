		...
		<div class="wrapper">
			...
			<aside class="main-sidebar">
				<div class="sidebar">
					<ul class="sidebar-menu">
						...
						<li><a href="${symbol_pound}!/dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
						<sec:authorize access="hasAnyRole('HR', 'ADMIN')">
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="${symbol_pound}!/admin/users"><i class="fa fa-user"></i> Users</a></li>
									<li><a href="${symbol_pound}!/admin/policies"><i class="fa fa-circle-o"></i> Policies</a></li>
								</ul>
							</li>
						</sec:authorize>
					</ul>
			...
			<aside class="control-sidebar control-sidebar-dark">
				...
				<ul class="nav nav-tabs nav-justified control-sidebar-tabs">
					<li class="active"><a href="${symbol_pound}control-sidebar-look-and-feel-tab" data-toggle="tab"><i class="fa fa-adjust"></i></a></li>
				</ul>
							...
							<li class="skin-preview"
								...
								<a href="" data-skin="skin-blue" class="clearfix full-opacity-hover"
								   style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)">
									...
									<div>
										<span style="display:block; width: 20%; float: left; height: 7px; background: ${symbol_pound}367fa9;"></span>
										<span class="bg-light-blue"
											  style="display:block; width: 80%; float: left; height: 7px;"></span>
									</div>
									<div>
										<span style="display:block; width: 20%; float: left; height: 20px; background: ${symbol_pound}222d32;"></span>
										<span style="display:block; width: 80%; float: left; height: 20px; background: ${symbol_pound}f4f5f7;"></span>
									</div>
								</a>
