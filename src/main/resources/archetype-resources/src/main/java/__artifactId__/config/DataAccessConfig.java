...
public class DataAccessConfig {
	...
	private @Value("${symbol_dollar}{jdbc.host}") String host;
	private @Value("${symbol_dollar}{jdbc.port}") int port;
	private @Value("${symbol_dollar}{jdbc.dbName}") String dbName;
	private @Value("${symbol_dollar}{jdbc.login}") String login;
	private @Value("${symbol_dollar}{jdbc.password}") String password;
	private @Value("${symbol_dollar}{jdbc.driverClassName}") String driverClass;
	private @Value("${symbol_dollar}{jdbc.maxPoolSize}") int maxPoolSize;
	private @Value("${symbol_dollar}{jdbc.minPoolSize}") int minPoolSize;
	private @Value("${symbol_dollar}{jdbc.maxStatements}") int maxStatements; 
	private @Value("${symbol_dollar}{jdbc.testConnection}") boolean testConnectionOnCheckout;
