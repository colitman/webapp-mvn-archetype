 ...
 */
package ${package}.${artifactId}.api.web.exceptions.handlers;
...
import ${package}.${artifactId}.api.web.exceptions.ErrorModel;
import ${package}.${artifactId}.api.web.exceptions.HttpBadRequestException;
import ${package}.${artifactId}.business.exception.ResourceForbiddenOperationException;
import ${package}.${artifactId}.business.exception.ResourceNotFoundException;
